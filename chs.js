...
var cnItems = {
    ...
    "\tAs of now, almost all your concerns have been taken care of !": "\t到目前为止，您的所有顾虑都已得到解决！",
    "\tIf one of the fixes I've done isn't enough for you, tell me what's missing !": "\t如果我所做的其中一项修复对您来说还不够，请告诉我缺少什么！",
    "After 1e10 of a ressource, each time your gain becomes 10x higher, your gain is brought to a power of 1/2": "在 1e10 资源后，每次增益提高 10 倍时，增益将变为 1/2 的幂",
    "All your stars (you begin with 2) can make up to a certain number of links with closests stars that havent got up to their limit (you begin with 1)": "你所有的星星（你从 2 开始）可以与最近的星星组成一定数量的链接，这些星星还没有达到他们的极限（你从 1 开始）",
    "Buy All": "购买所有",
    "Does this text gets dusty ? (Hint : Wait for the 4th layer !)": "这段文字会变得尘土飞扬吗？ （提示：等待第四层！）",
    "Each link is worth 1 star point, more links means more star points !": "每个链接值1星点，更多链接意味着更多星点！",
    "Each link made per tick gives 1 base star point, that can be increased with further upgrades.": "每个滴答声产生的每个链接都会提供 1 个基础星点，可以通过进一步升级来增加。",
    "get green stars": "获得绿色星星",
    "get red stars": "获得红星",
    "get yellow stars": "得到黄色星星",
    "Help": "帮助",
    "I've heard from you all on my server or on reddit !": "我在我的服务器或 reddit 上收到了大家的来信！",
    "It's a requirement upgrade ! Doesn't consumes your leaves !": "这是需求升级！不消耗你的叶子！",
    "Makes this layer's ticks 10% faster upon buying !": "购买时使这一层的滴答声加快 10%！",
    "More stars means more links to be possibly made !": "更多的星星意味着可以建立更多的链接！",
    "Nerfs :": "书呆子：",
    "Requires": "需要",
    "Star Points per tick": "星点数",
    "This will also autobuys every Constellation upgrade each tick !": "这也将自动购买每一次星座升级！",
    "Tries to buy every revelant upgrades once !": "尝试购买每个相关的升级一次！",
    "You are currently generating": "您当前正在生成",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Requires (.+) dusts$/, '需要 $1 尘埃'],
    [/^, (.+) comet dust\(s\)$/, '，$1 彗星尘埃'],
    [/^, (.+) bolt\(s\)$/, '，$1 螺栓'],
    [/^, (.+) leaf\(ves\)$/, '，$1 叶子'],
    [/^\(Req : (.+) Star Points\)$/, '\(要求 : $1 星点\)'],
    [/^\(Req : (.+) leaves\)$/, '\(要求 : $1 叶子\)'],
    [/^\(Req : (.+) bolts\)$/, '\(要求 : $1 螺栓\)'],
	[/^([\d\.]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+)\/sec$/, '$1\/秒'],
